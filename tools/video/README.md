...
| 06 | Three characters, one hitbox | — | — | Planned — brief: [devlog_characters_episodes.md](../../docs/marketing/devlog_characters_episodes.md) (episode A). Hook H8 unexpected number + speed flex. Veyra, Rook and Morrow; cosmetic-only rule; layer sheets; CHARACTERS tab |
| 07 | They land on their feet | — | — | Planned — same brief (episode B). Hook H6 pattern interrupt + question/challenge. Feet-first wall landings, the dive profile, the pre-attack coil, the 16× slow-motion bug |
