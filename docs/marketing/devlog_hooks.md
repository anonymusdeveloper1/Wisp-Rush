...
| 05 | H6 pattern interrupt | **Roster wall strike-out** (new §3.1 treatment): all 13 portraits fill the screen, six struck through in red on the spoken word | "I deleted six characters from my game. On purpose." → "Every one of them was a skeleton." (paid off by the frame contract and the registration lesson) |
| 06 | H1 shortcut promise | Speed flex (26 puppet parts burst out, then drain of colour under "IN THE BIN") | "A whole system went in the bin last week." → "Here's what it taught me, in forty seconds." |
| 07 | H8 unexpected number | **Counter slam** (new §3.1 treatment): one glowing "0" on black, then its unit, then a live spectrum of the game's own audio | "Zero. That's how many sound files are in my game." → "You're hearing it anyway." |
| 08 | H5 I know your pain | Question / challenge ("HOW MUCH MEMORY / IS A SHOP SCREEN?" over the real Shop, then the answer slams) | "If your game has ever run out of memory, I know the feeling." → "Mine wanted 858 megabytes. For a shop screen." |
