...
| `res://assets/art/branding/` | stacked wordmark logo, transparent app-icon master (`config/icon`), opaque store icon, splash master | redesign v1: `16_wordmark_logo`, `14_brand_mark` (splash/store icon composited on `#111521`) | generated art; confirm before release | logo 1318×956; boot splash set in project.godot | 2026-09-11 |
